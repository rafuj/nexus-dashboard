...
export const DeleteConfirmation: React.FC<ModalProps>  = ({ open, setOpen }) => {
      ...
      <form>
        <DialogContent className="sm:max-w-[440px] max-h-[90vh] flex flex-col py-12" showCloseButton={false}>
          <DialogHeader className="text-center">
            <DialogTitle className="text-2xl font-semibold text-accent-foreground mb-3">Are you sure you want to delete this group?</DialogTitle>
            <DialogDescription className="text-sm px-2">
              Deleting this group will permanently remove it from the system and may affect cabinet organization, member access, and related configurations.
            </DialogDescription>
          </DialogHeader>
